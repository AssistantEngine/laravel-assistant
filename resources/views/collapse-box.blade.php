<div>
    ...
    <button
        ...
        @if(count($items) > 0)
            <svg
                class="{{ $isCollapsed ? 'rotate-180' : '' }} hs-collapse-open:rotate-180 shrink-0 size-3"
    ...
    <div
        ...
        class="hs-collapse w-full overflow-hidden transition-[height] duration-300 {{ $isCollapsed ? '' : 'hidden' }}"
